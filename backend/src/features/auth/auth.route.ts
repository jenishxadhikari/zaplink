...
router.route('/auth/email/verify').post(AuthController.verifyEmail)

router
  .route('/auth/password/forgot')
  .post(validation(AuthSchema.forgotPasswordSchema), AuthController.forgotPassword)

router
  .route('/auth/password/reset')
  .post(validation(AuthSchema.resetPasswordSchema), AuthController.resetPassword)

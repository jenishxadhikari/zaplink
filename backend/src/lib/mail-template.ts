    ...
    <html><head><style>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Thank you for signing up! Click the button below to proceed with verifying your email.</p>
          <a href=${env.APP_ORIGIN}/email/verify?token=${token} class="button">Verify Email</a>
    ...
    <html><head><style>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="${env.APP_ORIGIN}/password/reset?token=${token}" class="button">Reset Password</a>
